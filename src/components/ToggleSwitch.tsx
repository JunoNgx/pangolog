...
export function ToggleSwitch({
    ...
    const buttonClasses =
        "flex items-center justify-center gap-1.5 w-full rounded-lg px-3 py-1 text-sm transition-colors peer-focus-visible:outline-2 peer-focus-visible:outline-offset-3 peer-focus-visible:outline-focus";

...
export function DemoDataBanner() {
    ...
    return (
        <div
            className={`/* CONTAINER */ /* INNER STRUCTURE */ /* VISUAL EFFECTS */ border-default-200 bg-surface-tertiary /* BEHAVIOR */ mx-auto mb-4 flex w-fit max-w-lg flex-col items-center gap-3 rounded-lg border px-4 py-3 sm:w-full sm:flex-row sm:items-center`}
        >
